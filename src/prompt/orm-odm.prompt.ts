...
export const ormOdmPrompt = {
  type: "list",
  name: "ormodms",
  message: "¿Qué ORM u ODM quieres usar?",
  choices: (answers: ProjectOptions) => {
    ...
    const database = getPropertieCliOpts(pmanager.databases, answers.database);

    return database.ormodms || [];
  },
};
